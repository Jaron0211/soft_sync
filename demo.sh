...
--tab -e 'bash -c "rosbag play imu/IMUbag/IMU_0.bag"' \
--tab -e 'bash -c "rosbag play imu/IMUbag/IMU_1.bag"' \
--tab -e 'bash -c "rosbag play imu/IMUbag/IMU_2.bag"' \
--tab -e 'bash -c "rosbag play imu/IMUbag/IMU_3.bag"' \
--tab -e 'bash -c "rosbag play imu/IMUbag/IMU_4.bag"'
